...
obj/__user_test_sequential_arrival.out:     file format elf64-littleriscv
...
exit(int error_code) {
  ...
  8000d6:	4b650513          	addi	a0,a0,1206 # 800588 <main+0x8c>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800130:	47478793          	addi	a5,a5,1140 # 8005a0 <main+0xa4>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80018c:	44ca8a93          	addi	s5,s5,1100 # 8005d4 <main+0xd8>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800194:	660b8b93          	addi	s7,s7,1632 # 8007f0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003ea:	1ea60613          	addi	a2,a2,490 # 8005d0 <main+0xd4>
  ...
  8003fc:	1c860613          	addi	a2,a2,456 # 8005c0 <main+0xc4>
  ...
  80040e:	1ae40413          	addi	s0,s0,430 # 8005b8 <main+0xbc>
  ...
  800498:	12440413          	addi	s0,s0,292 # 8005b8 <main+0xbc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004ae:	10fa0a13          	addi	s4,s4,271 # 8005b9 <main+0xbd>
...
int main(void) {
  ...
  800512:	4495                	li	s1,5
        ...
        pid = fork();
  800514:	bcdff0ef          	jal	ra,8000e0 <fork>
        if (pid == 0) {
  800518:	c51d                	beqz	a0,800546 <main+0x4a>
    for (i = 0; i < child_count; i++) {
  80051a:	2405                	addiw	s0,s0,1
  80051c:	fe941ce3          	bne	s0,s1,800514 <main+0x18>
  800520:	4415                	li	s0,5
    ...
    for (i = 0; i < child_count; i++) {
  800522:	347d                	addiw	s0,s0,-1
        waitpid(-1, NULL);
  800524:	4581                	li	a1,0
  800526:	557d                	li	a0,-1
  800528:	bbbff0ef          	jal	ra,8000e2 <waitpid>
    for (i = 0; i < child_count; i++) {
  80052c:	f87d                	bnez	s0,800522 <main+0x26>
    }
    
    cprintf("test_sequential_arrival: all children finished\n");
  80052e:	00000517          	auipc	a0,0x0
  800532:	3ea50513          	addi	a0,a0,1002 # 800918 <error_string+0x128>
  800536:	b0bff0ef          	jal	ra,800040 <cprintf>
    return 0;
}
  80053a:	70a2                	ld	ra,40(sp)
  80053c:	7402                	ld	s0,32(sp)
  80053e:	64e2                	ld	s1,24(sp)
  800540:	4501                	li	a0,0
  800542:	6145                	addi	sp,sp,48
  800544:	8082                	ret
            int workload = 50000 + i * 30000;  // Increasing workload
  800546:	649d                	lui	s1,0x7
  800548:	5304849b          	addiw	s1,s1,1328
  80054c:	029404bb          	mulw	s1,s0,s1
  800550:	67b1                	lui	a5,0xc
  800552:	3507879b          	addiw	a5,a5,848
            volatile int sum = 0;
  800556:	c602                	sw	zero,12(sp)
            int workload = 50000 + i * 30000;  // Increasing workload
  800558:	9cbd                	addw	s1,s1,a5
                sum += j;
  80055a:	47b2                	lw	a5,12(sp)
  80055c:	9fa9                	addw	a5,a5,a0
  80055e:	c63e                	sw	a5,12(sp)
            for (j = 0; j < workload; j++) {
  800560:	2505                	addiw	a0,a0,1
  800562:	fe954ce3          	blt	a0,s1,80055a <main+0x5e>
            cprintf("child %d (pid %d, work %d) finished\n", myid, getpid(), workload);
  800566:	b7fff0ef          	jal	ra,8000e4 <getpid>
  80056a:	862a                	mv	a2,a0
  80056c:	86a6                	mv	a3,s1
  80056e:	85a2                	mv	a1,s0
  800570:	00000517          	auipc	a0,0x0
  800574:	38050513          	addi	a0,a0,896 # 8008f0 <error_string+0x100>
  800578:	ac9ff0ef          	jal	ra,800040 <cprintf>
            exit(0);
  80057c:	4501                	li	a0,0
  80057e:	b4dff0ef          	jal	ra,8000ca <exit>
