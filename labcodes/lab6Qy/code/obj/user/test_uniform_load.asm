...
obj/__user_test_uniform_load.out:     file format elf64-littleriscv
...
exit(int error_code) {
  ...
  8000d6:	4a650513          	addi	a0,a0,1190 # 800578 <main+0x7c>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800130:	46478793          	addi	a5,a5,1124 # 800590 <main+0x94>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80018c:	43ca8a93          	addi	s5,s5,1084 # 8005c4 <main+0xc8>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800194:	650b8b93          	addi	s7,s7,1616 # 8007e0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003ea:	1da60613          	addi	a2,a2,474 # 8005c0 <main+0xc4>
  ...
  8003fc:	1b860613          	addi	a2,a2,440 # 8005b0 <main+0xb4>
  ...
  80040e:	19e40413          	addi	s0,s0,414 # 8005a8 <main+0xac>
  ...
  800498:	11440413          	addi	s0,s0,276 # 8005a8 <main+0xac>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004ae:	0ffa0a13          	addi	s4,s4,255 # 8005a9 <main+0xad>
...
int main(void) {
  ...
  800502:	3aa50513          	addi	a0,a0,938 # 8008a8 <error_string+0xc8>
int main(void) {
  ...
  800532:	3d250513          	addi	a0,a0,978 # 800900 <error_string+0x120>
  ...
  800544:	8082                	ret
            for (j = 0; j < cpuload; j++) {
  800546:	6761                	lui	a4,0x18
            volatile int sum = 0;
  800548:	c602                	sw	zero,12(sp)
            for (j = 0; j < cpuload; j++) {
  80054a:	6a070713          	addi	a4,a4,1696 # 186a0 <_start-0x7e7980>
                sum += j;
  80054e:	47b2                	lw	a5,12(sp)
  800550:	9fa9                	addw	a5,a5,a0
  800552:	c63e                	sw	a5,12(sp)
            for (j = 0; j < cpuload; j++) {
  800554:	2505                	addiw	a0,a0,1
  800556:	fee51ce3          	bne	a0,a4,80054e <main+0x52>
            cprintf("child %d (pid %d) finished with sum=%d\n", i, getpid(), sum);
  80055a:	b8bff0ef          	jal	ra,8000e4 <getpid>
  80055e:	46b2                	lw	a3,12(sp)
  800560:	862a                	mv	a2,a0
  800562:	85a2                	mv	a1,s0
  800564:	2681                	sext.w	a3,a3
  800566:	00000517          	auipc	a0,0x0
  80056a:	37250513          	addi	a0,a0,882 # 8008d8 <error_string+0xf8>
  80056e:	ad3ff0ef          	jal	ra,800040 <cprintf>
            exit(0);
  800572:	4501                	li	a0,0
  800574:	b57ff0ef          	jal	ra,8000ca <exit>
