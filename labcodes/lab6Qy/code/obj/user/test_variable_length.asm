...
obj/__user_test_variable_length.out:     file format elf64-littleriscv
...
exit(int error_code) {
  ...
  8000d6:	4ce50513          	addi	a0,a0,1230 # 8005a0 <main+0xa4>
...
umain(void) {
  ...
  8000ea:	412000ef          	jal	ra,8004fc <main>
    exit(ret);
  8000ee:	fddff0ef          	jal	ra,8000ca <exit>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800130:	48c78793          	addi	a5,a5,1164 # 8005b8 <main+0xbc>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80018c:	464a8a93          	addi	s5,s5,1124 # 8005ec <main+0xf0>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800194:	678b8b93          	addi	s7,s7,1656 # 800808 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003ea:	20260613          	addi	a2,a2,514 # 8005e8 <main+0xec>
  ...
  8003fc:	1e060613          	addi	a2,a2,480 # 8005d8 <main+0xdc>
  ...
  80040e:	1c640413          	addi	s0,s0,454 # 8005d0 <main+0xd4>
  ...
  800498:	13c40413          	addi	s0,s0,316 # 8005d0 <main+0xd4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004ae:	127a0a13          	addi	s4,s4,295 # 8005d1 <main+0xd5>
...
int main(void) {
  8004fc:	7139                	addi	sp,sp,-64
    cprintf("test_variable_length: variable workload test\n");
  8004fe:	00000517          	auipc	a0,0x0
  800502:	3d250513          	addi	a0,a0,978 # 8008d0 <error_string+0xc8>
int main(void) {
  800506:	f822                	sd	s0,48(sp)
  800508:	f426                	sd	s1,40(sp)
  80050a:	fc06                	sd	ra,56(sp)
    cprintf("test_variable_length: variable workload test\n");
  ...
  800514:	4487b783          	ld	a5,1096(a5) # 800958 <error_string+0x150>
  800518:	e43e                	sd	a5,8(sp)
  80051a:	00000797          	auipc	a5,0x0
  80051e:	4467b783          	ld	a5,1094(a5) # 800960 <error_string+0x158>
  800522:	e83e                	sd	a5,16(sp)
  800524:	67d1                	lui	a5,0x14
  800526:	88078793          	addi	a5,a5,-1920 # 13880 <_start-0x7ec7a0>
  80052a:	cc3e                	sw	a5,24(sp)
    int child_count = 5;
    int i, pid;
  ...
  80052e:	4495                	li	s1,5
        pid = fork();
  800530:	bb1ff0ef          	jal	ra,8000e0 <fork>
        if (pid == 0) {
  800534:	c51d                	beqz	a0,800562 <main+0x66>
    for (i = 0; i < child_count; i++) {
  800536:	2405                	addiw	s0,s0,1
  800538:	fe941ce3          	bne	s0,s1,800530 <main+0x34>
  80053c:	4415                	li	s0,5
            exit(0);
        }
    }
    ...
    for (i = 0; i < child_count; i++) {
  80053e:	347d                	addiw	s0,s0,-1
        waitpid(-1, NULL);
  800540:	4581                	li	a1,0
  800542:	557d                	li	a0,-1
  800544:	b9fff0ef          	jal	ra,8000e2 <waitpid>
    for (i = 0; i < child_count; i++) {
  800548:	f87d                	bnez	s0,80053e <main+0x42>
    }
    
    cprintf("test_variable_length: all children finished\n");
  80054a:	00000517          	auipc	a0,0x0
  80054e:	3de50513          	addi	a0,a0,990 # 800928 <error_string+0x120>
  800552:	aefff0ef          	jal	ra,800040 <cprintf>
    return 0;
}
  800556:	70e2                	ld	ra,56(sp)
  800558:	7442                	ld	s0,48(sp)
  80055a:	74a2                	ld	s1,40(sp)
  80055c:	4501                	li	a0,0
  80055e:	6121                	addi	sp,sp,64
  800560:	8082                	ret
            for (j = 0; j < workloads[i]; j++) {
  800562:	00241793          	slli	a5,s0,0x2
  800566:	1018                	addi	a4,sp,32
  800568:	97ba                	add	a5,a5,a4
  80056a:	fe87a483          	lw	s1,-24(a5)
            volatile int sum = 0;
  80056e:	c202                	sw	zero,4(sp)
            for (j = 0; j < workloads[i]; j++) {
  800570:	00955763          	bge	a0,s1,80057e <main+0x82>
                sum += j;
  800574:	4792                	lw	a5,4(sp)
  800576:	9fa9                	addw	a5,a5,a0
  800578:	c23e                	sw	a5,4(sp)
            for (j = 0; j < workloads[i]; j++) {
  80057a:	2505                	addiw	a0,a0,1
  80057c:	bfd5                	j	800570 <main+0x74>
            cprintf("child %d (pid %d, load %d) finished\n", i, getpid(), workloads[i]);
  80057e:	b67ff0ef          	jal	ra,8000e4 <getpid>
  800582:	862a                	mv	a2,a0
  800584:	86a6                	mv	a3,s1
  800586:	85a2                	mv	a1,s0
  800588:	00000517          	auipc	a0,0x0
  80058c:	37850513          	addi	a0,a0,888 # 800900 <error_string+0xf8>
  800590:	ab1ff0ef          	jal	ra,800040 <cprintf>
            exit(0);
  800594:	4501                	li	a0,0
  800596:	b35ff0ef          	jal	ra,8000ca <exit>
